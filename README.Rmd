...
You can install the released version of igoR from [CRAN](https://CRAN.R-project.org) with:
...
R package version `r packageVersion("igoR")`. 
Package url: https://dieghernan.github.io/igoR/
