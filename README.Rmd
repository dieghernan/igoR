...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/igoR)](https://CRAN.R-project.org/package=igoR)
[![CRAN results](https://cranchecks.info/badges/worst/igoR)](https://cran.r-project.org/web/checks/check_results_igoR.html)
...
Additionally, a distribution of the State System Membership (@cow_2017) is included on this package.
