...
This outlines how to propose a change to igoR. For a detailed discussion
on contributing to this package, please see the [development
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("dieghernan/igoR", fork = TRUE)`.
...
Please note that the igoR project is released with a [Contributor Code
of Conduct](https://dieghernan.github.io/igoR/CODE_OF_CONDUCT.md). By
