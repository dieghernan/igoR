...
#> Error in eval(expr, envir, enclos): object 'UN1950' not found
```
...
#> Error in eval(expr, envir, enclos): object 'UN_all' not found
```
...
#> Error in eval(expr, envir, enclos): object 'sharedmap' not found
```
