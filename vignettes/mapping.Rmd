...
#> [1] igoR_0.1.1.9000   tmap_3.3-2        giscoR_0.2.4.9000 sf_1.0-2         
#> [5] countrycode_1.3.0 dplyr_1.0.7      
#> 
#> loaded via a namespace (and not attached):
#>   [1] leafem_0.1.6       ellipsis_0.3.2     class_7.3-19       gitcreds_0.1.1    
#>   [5] leaflet_2.0.4.1    rprojroot_2.0.2    base64enc_0.1-3    fs_1.5.0          
#>   [9] dichromat_2.0-0    httpcode_0.3.0     rstudioapi_0.13    proxy_0.4-26      
#>  [13] roxygen2_7.1.1     urltools_1.7.3     remotes_2.4.0      gh_1.3.0          
#>  [17] fansi_0.5.0        pkgdev_0.0.1.9000  xml2_1.3.2         codetools_0.2-18  
#>  [21] R.methodsS3_1.8.1  cachem_1.0.5       knitr_1.33         pkgload_1.2.1     
#>  [25] jsonlite_1.7.2     tmaptools_3.1-1    png_0.1-7          R.oo_1.24.0       
#>  [29] compiler_4.1.0     httr_1.4.2         backports_1.2.1    assertthat_0.2.1  
#>  [33] fastmap_1.1.0      cli_3.0.1          s2_1.0.6           htmltools_0.5.1.1 
#>  [37] prettyunits_1.1.1  tools_4.1.0        glue_1.4.2         wk_0.5.0          
#>  [41] V8_3.4.2           Rcpp_1.0.7         styler_1.5.1       raster_3.4-13     
#>  [45] xopen_1.0.0        vctrs_0.3.8        crul_1.1.0         leafsync_0.1.0    
#>  [49] crosstalk_1.1.1    lwgeom_0.2-7       xfun_0.24          stringr_1.4.0     
#>  [53] ps_1.6.0           testthat_3.0.4     lifecycle_1.0.0    sys_3.4           
#>  [57] devtools_2.4.2     XML_3.99-0.6       jsonld_2.2         ragg_1.1.3        
#>  [61] credentials_1.3.1  parallel_4.1.0     rematch2_2.1.2     RColorBrewer_1.1-2
#>  [65] gert_1.3.1         yaml_2.2.1         curl_4.3.2         memoise_2.0.0     
#>  [69] rcmdcheck_1.3.3    triebeard_0.3.0    stringi_1.7.3      highr_0.9         
#>  [73] desc_1.3.0         e1071_1.7-8        pingr_2.0.1        pkgbuild_1.2.0    
#>  [77] systemfonts_1.0.2  rlang_0.4.11       pkgconfig_2.0.3    commonmark_1.7    
#>  [81] lattice_0.20-44    evaluate_0.14      purrr_0.3.4        htmlwidgets_1.5.3 
#>  [85] processx_3.5.2     tidyselect_1.1.1   geojsonsf_2.0.1    magrittr_2.0.1    
#>  [89] R6_2.5.0           generics_0.1.0     DBI_1.1.1          pillar_1.6.2      
#>  [93] withr_2.4.2        units_0.7-2        stars_0.5-3        sp_1.4-5          
#>  [97] abind_1.4-5        tibble_3.1.3       crayon_1.4.1       KernSmooth_2.23-20
#> [101] utf8_1.2.2         rmarkdown_2.9      urlchecker_1.0.0   usethis_2.0.1     
#> [105] grid_4.1.0         codemetar_0.3.2    callr_3.7.0        digest_0.6.27     
#> [109] classInt_0.4-3     R.cache_0.15.0     textshaping_0.3.5  R.utils_2.10.1    
#> [113] openssl_1.4.4      viridisLite_0.4.0  sessioninfo_1.1.1  askpass_1.1
#> ***
#> vignette running time:
#> Time difference of 18.38552 secs
```
</details>
