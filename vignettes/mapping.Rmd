...
#> [1] tmap_3.3-1        giscoR_0.2.4      sf_0.9-8          countrycode_1.2.0
#> [5] dplyr_1.0.5       igoR_0.1.1.9000   knitr_1.32       
#> 
#> loaded via a namespace (and not attached):
#>  [1] pkgload_1.2.1      viridisLite_0.4.0  assertthat_0.2.1  
#>  [4] sp_1.4-5           highr_0.9          remotes_2.3.0     
#>  [7] sessioninfo_1.1.1  pillar_1.6.0       lattice_0.20-41   
#> [10] glue_1.4.2         digest_0.6.27      RColorBrewer_1.1-2
#> [13] htmltools_0.5.1.1  XML_3.99-0.5       pkgconfig_2.0.3   
#> [16] devtools_2.4.0     raster_3.4-5       stars_0.5-2       
#> [19] purrr_0.3.4        processx_3.5.1     tibble_3.1.0      
#> [22] proxy_0.4-25       generics_0.1.0     usethis_2.0.1     
#> [25] ellipsis_0.3.1     cachem_1.0.4       withr_2.4.1       
#> [28] leafsync_0.1.0     cli_2.4.0          magrittr_2.0.1    
#> [31] crayon_1.4.1       memoise_2.0.0      evaluate_0.14     
#> [34] ps_1.6.0           fs_1.5.0           fansi_0.4.2       
#> [37] lwgeom_0.2-6       class_7.3-17       geojsonsf_2.0.1   
#> [40] pkgbuild_1.2.0     textshaping_0.3.3  tools_4.0.3       
#> [43] prettyunits_1.1.1  lifecycle_1.0.0    stringr_1.4.0     
#> [46] callr_3.6.0        compiler_4.0.3     e1071_1.7-6       
#> [49] systemfonts_1.0.1  rlang_0.4.10       classInt_0.4-3    
#> [52] units_0.7-1        grid_4.0.3         tmaptools_3.1-1   
#> [55] dichromat_2.0-0    rstudioapi_0.13    htmlwidgets_1.5.3 
#> [58] crosstalk_1.1.1    leafem_0.1.3       base64enc_0.1-3   
#> [61] testthat_3.0.2     codetools_0.2-16   abind_1.4-5       
#> [64] DBI_1.1.1          R6_2.5.0           fastmap_1.1.0     
#> [67] utf8_1.2.1         rprojroot_2.0.2    ragg_1.1.2        
#> [70] KernSmooth_2.23-17 desc_1.3.0         stringi_1.5.3     
#> [73] parallel_4.0.3     Rcpp_1.0.6         vctrs_0.3.7       
#> [76] png_0.1-7          leaflet_2.0.4.1    tidyselect_1.1.0  
#> [79] xfun_0.22
#> ***
#> vignette running time:
#> Time difference of 29.24968 secs
```
</details>
