...
Note that for 1950 and 1980 the map 
is not completely accurate, as the base shapefile contains the countries 
that exists on 2010 and some countries 
...
# ISO3 Code
shared$ISO3_CODE <- countrycode(sharedESP$ccode2,
                                   "cown",
                                   "iso3c",
                                   warn = FALSE)
...
tm_shape(sharedmap) +
  ...
  tm_shape(subset(sharedmap, ISO3_CODE == "AUL")) +
