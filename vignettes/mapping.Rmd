...
un_all <- igo_members("UN", c(1950, 1980, 2010),
  status = c("Full Membership", "No Membership")
) %>%
  # Add ISO3 Code
...
ggplot(un_all_sf) +
  ...
  scale_fill_manual(
    values = c("Full Membership" = "#74A9CF", "No Membership" = "#FF7F7F"),
    na.value = "#E0E0E0",
    # Reorder legend
    limits = c("Full Membership", "No Membership", NA),
    # Relabel legend
    labels = c("Full Membership", "No Membership", "N/A")
  ) +
  labs(
