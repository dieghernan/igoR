...
#> Error in select(., year, orgname, ISO3_CODE, category): could not find function "select"
...
#> Error in left_join(., un_all, by = c("ISO3_CODE", "year")): could not find function "left_join"
```
...
#> Error in ggplot(un_all_sf): could not find function "ggplot"
```
...
#> Error in select(., ISO3_CODE, shared): could not find function "select"
...
#> Error in ggplot(sharedmap): could not find function "ggplot"
```
...
#> Error in select(., ISO3_CODE, year, value): could not find function "select"

# Create map
# Get shapes
countries_sf <- gisco_get_countries(country = c("USA", "MEX", "CAN")) %>%
  left_join(all, by = "ISO3_CODE")
#> Error in left_join(., all, by = "ISO3_CODE"): could not find function "left_join"
...
#> Error in ggplot(countries_sf): could not find function "ggplot"
```
