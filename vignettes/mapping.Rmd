...
#> [1] igoR_0.1.1.9010   tmap_3.3-2        giscoR_0.2.4.9004 sf_1.0-2         
#> [5] countrycode_1.3.0 dplyr_1.0.7      
#> 
#> loaded via a namespace (and not attached):
#>  [1] fs_1.5.0           xopen_1.0.0        usethis_2.0.1      devtools_2.4.2    
#>  [5] RColorBrewer_1.1-2 rprojroot_2.0.2    R.cache_0.15.0     tools_4.1.0       
#>  [9] backports_1.2.1    utf8_1.2.2         R6_2.5.0           KernSmooth_2.23-20
#> [13] DBI_1.1.1          raster_3.4-13      urlchecker_1.0.0   withr_2.4.2       
#> [17] sp_1.4-5           tidyselect_1.1.1   prettyunits_1.1.1  processx_3.5.2    
#> [21] leaflet_2.0.4.1    curl_4.3.2         compiler_4.1.0     textshaping_0.3.5 
#> [25] leafem_0.1.6       cli_3.0.1          geojsonsf_2.0.1    xml2_1.3.2        
#> [29] desc_1.3.0         classInt_0.4-3     callr_3.7.0        proxy_0.4-26      
#> [33] systemfonts_1.0.2  commonmark_1.7     stringr_1.4.0      digest_0.6.27     
#> [37] rmarkdown_2.9      R.utils_2.10.1     base64enc_0.1-3    dichromat_2.0-0   
#> [41] pkgconfig_2.0.3    htmltools_0.5.1.1  sessioninfo_1.1.1  styler_1.5.1      
#> [45] pkgdev_0.0.1.9002  fastmap_1.1.0      highr_0.9          htmlwidgets_1.5.3 
#> [49] rlang_0.4.11       rstudioapi_0.13    generics_0.1.0     crosstalk_1.1.1   
#> [53] R.oo_1.24.0        magrittr_2.0.1     s2_1.0.6           Rcpp_1.0.7        
#> [57] fansi_0.5.0        abind_1.4-5        lifecycle_1.0.0    R.methodsS3_1.8.1 
#> [61] stringi_1.7.3      leafsync_0.1.0     yaml_2.2.1         tmaptools_3.1-1   
#> [65] pkgbuild_1.2.0     grid_4.1.0         parallel_4.1.0     crayon_1.4.1      
#> [69] lattice_0.20-44    stars_0.5-3        knitr_1.33         ps_1.6.0          
#> [73] pillar_1.6.2       codetools_0.2-18   pkgload_1.2.1      wk_0.5.0          
#> [77] XML_3.99-0.6       glue_1.4.2         evaluate_0.14      remotes_2.4.0     
#> [81] vctrs_0.3.8        png_0.1-7          testthat_3.0.4     rcmdcheck_1.3.3   
#> [85] purrr_0.3.4        assertthat_0.2.1   cachem_1.0.5       xfun_0.24         
#> [89] lwgeom_0.2-7       e1071_1.7-8        roxygen2_7.1.1     ragg_1.1.3        
#> [93] class_7.3-19       viridisLite_0.4.0  tibble_3.1.3       memoise_2.0.0     
#> [97] units_0.7-2        ellipsis_0.3.2
#> ***
#> vignette running time:
#> Time difference of 18.19725 secs
```
</details>
