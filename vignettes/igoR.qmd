...
information on the IGO datasets and additional downloads, see [Intergovernmental
Organizations (v3)](https://correlatesofwar.org/data-sets/IGOs/).

*Note that the dyadic dataset is not included in the package due to its size
...
>
> The dataset begins to code an IGO by identifying the first year in which the
...
on @pevehouse2020 and the complementary replication dataset [@priorep]:
