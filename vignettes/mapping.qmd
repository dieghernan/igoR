...
(COW, ISO3, NUTS, FIPS) and country names.
...
code produces a map showing how many full memberships each country shared
...
have evolved over the last 90 years, with one year representing each decade.
...
<div class="figure">
<img src="./fig-NAShared-1.png" alt="Shared Full Memberships on North America (1930 - 2010)" width="100%" />
