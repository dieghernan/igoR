...
description: >
  Integrating IGO data into mapping projects.
...
intergovernmental organizations (IGOs), maps can show how IGO membership
...
code maps how many full joint memberships each state shared with Australia in
2014.
