...
Thanks for using igoR! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/dieghernan/igoR/issues/new).
...
requests](https://github.com/dieghernan/igoR/issues) to make sure the
